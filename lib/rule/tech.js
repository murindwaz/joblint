...
function defineRules (linter) {
    ...
    linter.addRule({
        ...
        test: function (spec, result) {
            ...
            if (legacyTechMentions.length > 0) {
                result.addNotice(
                    'Technologies anciennes trouvés: ' +
    ...
    linter.addRule({
        name: 'Environnement de développement prescrits',
        ...
        test: function (spec, result) {
            ...
            if (environmentMentions.length > 0) {
                result.addNotice(
                    'Ces environnements de développement sont prescrits: ' +
